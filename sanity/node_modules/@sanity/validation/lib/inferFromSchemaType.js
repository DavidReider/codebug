...
function inferFromSchemaType(typeDef, schema) {
  ...
  var typed = _Rule.default[typeDef.jsonType];
  var base = typed ? typed(typeDef) : new _Rule.default(typeDef);
  ...
  if (type && type.name === 'slug') {
    base = base.custom(_slugValidator.slugValidator);
  }
  ...
  if (type && type.name === 'block') {
    base = base.block(_blockValidator.blockValidator);
  }
