...
class Rule {
  ...
  clone() {
    ...
    rule._rules = (0, _cloneDeep.default)(this._rules);
  ...
  validate(value) {
    ...
    return (0, _validate.default)(this, value, options);
  ...
  uri() {
    ...
    options.scheme = allowedSchemes.map(scheme => {
      ...
      return schemeIsString ? new RegExp("^".concat((0, _escapeRegex.default)(scheme), "$")) : scheme;
    });
