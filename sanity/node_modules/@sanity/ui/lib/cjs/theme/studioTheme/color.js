...
const color = (0, import_theme.createColorTheme)({
  ...
  muted: ({ base, dark, state, tone }) => {
    ...
    if (state === "disabled") {
      ...
      const skeletonFrom2 = mix(bg, tints[dark ? 900 : 100].hex);
      return {
        bg,
    ...
    if (state === "hovered") {
      ...
      return {
        ...
        accent: {
          fg: mix(base.bg, import_color.hues.red[dark ? 300 : 700].hex)
        },
        link: {
          fg: mix(base.bg, import_color.hues.blue[dark ? 300 : 700].hex)
        },
        code: {
          bg: mix(bg, tints[dark ? 950 : 50].hex),
          fg: mix(base.bg, tints[dark ? 300 : 700].hex)
    ...
    if (state === "pressed") {
      ...
      return {
        ...
        accent: {
          fg: mix(bg, import_color.hues.red[dark ? 300 : 700].hex)
        },
        link: {
          fg: mix(bg, import_color.hues.blue[dark ? 300 : 700].hex)
        },
        code: {
          bg: mix(bg, tints[dark ? 950 : 50].hex),
          fg: mix(base.bg, tints[dark ? 300 : 700].hex)
  ...
  card: ({ base, dark, muted, name, state }) => {
    ...
    if (state === "selected") {
      ...
      tints = ["default", "transparent"].includes(name) ? import_color.hues.blue : tints;
